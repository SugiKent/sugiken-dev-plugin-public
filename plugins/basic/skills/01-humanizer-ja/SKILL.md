---
name: 01-humanizer-ja
description: "AI（Claude・ChatGPT・Gemini 等）が生成した『AIくさい日本語』を、人間が書いたように読める文章へ書き換えるスキル。意義の過剰強調・定型評価語・太字+コロン箇条書き・全角ダッシュ・否定並列構文・『することができます』の多用など 20 パターンを検出し、消すだけでなく人間らしい表現（具体的な数字・体験・意見）へ置き換える。最後に『この文章を読んで AI が書いたと思うか』でセルフ監査する。「人間っぽくして」「humanize」「AIくさい」「AIっぽさを消して」「文章を自然にして」「humanizer」等の発話・タスク要求時に使用。"
---
...
WikiProject AI Cleanupの知見をベースに、日本語特有のパターンを追加。英語版 [blader/humanizer](https://github.com/blader/humanizer) にインスパイアされたオリジナル実装（原典: [gonta223/humanizer-ja](https://github.com/gonta223/humanizer-ja)、作者: SuguruKun_ai、MIT License）。

---

## 使い方

文章を生成した後、「人間っぽくして」「humanize」等と指示する。以下の20パターンをチェックし、該当箇所を書き換える。
